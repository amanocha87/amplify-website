...
export default function Footer() {
  return (
    <footer className="bg-purple-600 text-white pt-14 pb-8 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-12">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2.5 text-white/90 text-sm">
              <li><Link to="/services/business-consultancy" className="hover:text-purple-950 transition-colors">Business Consultancy</Link></li>
              <li><Link to="/services/customer-engagement" className="hover:text-purple-950 transition-colors">Customer Engagement</Link></li>
              <li><Link to="/services/business-systems" className="hover:text-purple-950 transition-colors">Business Systems</Link></li>
              <li><Link to="/services/digital-growth" className="hover:text-purple-950 transition-colors">Digital Growth</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2.5 text-white/90 text-sm">
              <li><Link to="/industries/motor-trade" className="hover:text-purple-950 transition-colors">Motor Trade</Link></li>
              <li><Link to="/industries/estate-agencies" className="hover:text-purple-950 transition-colors">Estate Agencies</Link></li>
              <li><Link to="/industries/trades-home-services" className="hover:text-purple-950 transition-colors">Trades & Home Services</Link></li>
              <li><Link to="/industries" className="hover:text-purple-950 transition-colors font-medium">View all industries →</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2.5 text-white/90 text-sm">
              <li><Link to="/about" className="hover:text-purple-950 transition-colors">About</Link></li>
              <li><Link to="/insights" className="hover:text-purple-950 transition-colors">Insights</Link></li>
              <li><Link to="/contact" className="hover:text-purple-950 transition-colors">Contact</Link></li>
              <li><Link to="/referral-rewards" className="hover:text-purple-950 transition-colors">Referral Rewards</Link></li>
            </ul>
          </div>
        </div>
